  ...
  return (
    ...
    <header
      className={`fixed inset-x-0 top-0 z-50 text-parchment-100 transition-all duration-700 ${
        scrolled || open
          ? "bg-basalt-950/97 shadow-[0_1px_0_0_rgba(158,45,51,0.42)] backdrop-blur-md"
    ...
    >
      <div className="mx-auto flex h-20 max-w-[90rem] items-center justify-between gap-6 px-5 md:px-8">
        ...
        <nav className="hidden min-w-0 items-center justify-end gap-5 xl:flex xl:gap-7" aria-label="Primary">
          ...
          <Link
            href={`/${locale}/contact`}
            className="gold-sheen-border whitespace-nowrap border bg-crimson-500/10 px-4 py-2 text-[0.75rem] tracking-[0.16em] text-parchment-50 uppercase transition-colors duration-500 hover:bg-crimson-500/22"
          >
